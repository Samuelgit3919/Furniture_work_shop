...
const reasons = [
  ...
  { icon: '📍', title: '4 City Branches', text: 'Showrooms in Addis Ababa, Adama, Hawassa, and Bahir Dar — always close to where you are in Ethiopia.' },
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <Reveal className="text-center mb-14">
          <div className="flex items-center justify-center gap-4 mb-3">
            ...
            <span className="text-[#C9A84C] text-[0.68rem] tracking-[0.22em] uppercase font-semibold">Why Habesha Living</span>
            <span className="flex-1 max-w-[80px] h-px bg-[#C9A84C]/30" />
          </div>
          <h2 className="font-serif text-white text-[clamp(1.9rem,4vw,2.9rem)] font-semibold leading-tight">
            The <em className="text-[#E8C97A] not-italic italic">Habesha</em> Difference
          </h2>
        </Reveal>
